...
// 	PORT_Init(PORTA, PIN10, PORTA_PIN10_SPI0_MOSI, 0);	//I2S_DO
	...
	I2S_MCLKConfig(SPI0, 1, 44100 * 64);
	I2S_Open(SPI0);
	
	SPI0->CTRL &= ~SPI_CTRL_SIZE_Msk;	// 这句必须有
...
void I2S_Slave_Init(void)
{
	...
	PORT_Init(PORTC, PIN4, PORTC_PIN4_SPI1_SSEL, 1);	// I2S_WS
	PORT_Init(PORTC, PIN7, PORTC_PIN7_SPI1_SCLK, 1);	// I2S_CK
	PORT_Init(PORTC, PIN5, PORTC_PIN5_SPI1_MISO, 0);	// I2S_DO
//	PORT_Init(PORTC, PIN6, PORTC_PIN6_SPI1_MOSI, 1);	// I2S_DI
	...
	DMA_initStruct.Trigger = DMA_CH3_SPI1TX;
	DMA_initStruct.Priority = DMA_PRI_LOW;
...
void DMA_Handler(void)
{
	...
	/* Slave TX */
	if(DMA_CH_INTStat(DMA_CH3, DMA_IT_SRCSG_HALF))
	{
		DMA_CH_INTClr(DMA_CH3, DMA_IT_SRCSG_HALF);
		
		TX_DoneIndex = (1 << 1) | 0;
	}
	else if(DMA_CH_INTStat(DMA_CH3, DMA_IT_SRCSG_DONE))
	{
		DMA_CH_INTClr(DMA_CH3, DMA_IT_SRCSG_DONE);
