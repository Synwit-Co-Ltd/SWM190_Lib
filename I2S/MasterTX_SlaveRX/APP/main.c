...
//	PORT_Init(PORTC, PIN5, PORTC_PIN5_SPI1_MISO, 0);	// I2S_DO
	...
	DMA_initStruct.Trigger = DMA_CH2_SPI1RX;
	DMA_initStruct.Priority = DMA_PRI_LOW;
...
void DMA_Handler(void)
{
	...
	/* Slave RX */
	if(DMA_CH_INTStat(DMA_CH2, DMA_IT_DSTSG_HALF))
	{
		DMA_CH_INTClr(DMA_CH2, DMA_IT_DSTSG_HALF);
		
		RX_DoneIndex = (1 << 1) | 0;
		
		GPIO_InvBit(GPIOA, PIN5);
	}
	else if(DMA_CH_INTStat(DMA_CH2, DMA_IT_DSTSG_DONE))
	{
		DMA_CH_INTClr(DMA_CH2, DMA_IT_DSTSG_DONE);
